...
SECRET_KEY = 'django-insecure-*x--mhi@x(vt$z5@tob1md2&3)((uwsr@b+d(2+g&3jkz6uec3'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:\\Users\\VERF_\\OneDrive\\Escritorio\\mis_entornos\\mi_web\\src\\proyecto\\base\\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
